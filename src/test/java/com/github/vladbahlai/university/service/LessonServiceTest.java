...
public class LessonServiceTest {
    ...
    void shouldReturnLessonsFromDepartment() {
        ...
        List<Teacher> teacherList = Arrays.asList(new Teacher(1L, "test", "123", "email@example.com"), new Teacher(2L, "test", "123", "email@example.com"));
        ...
        List<Lesson> lessonsFromFirstTeacher = Collections.singletonList(
                new Lesson(1L, new Discipline(1L, "test1", 3.0, 120, Course.FIRST, new Specialty(1L, "test")),
                        new Group(1L, "test1", Course.FIRST, new Specialty(1L, "test")), new Teacher(1L, "test1", "123", "email@example.com"), LocalDate.of(2022, 12, 10),
        ...
        List<Lesson> lessonsFromSecondTeacher = Arrays.asList(
                new Lesson(2L, new Discipline(2L, "test2", 3.0, 120, Course.FIRST, new Specialty(1L, "test")),
                        new Group(2L, "test2", Course.FIRST, new Specialty(1L, "test")), new Teacher(2L, "test2", "123", "email@example.com"), LocalDate.of(2022, 12, 10),
                ...
                new Lesson(3L, new Discipline(3L, "test3", 3.0, 120, Course.FIRST, new Specialty(1L, "test")),
                        new Group(3L, "test3", Course.FIRST, new Specialty(1L, "test")), new Teacher(3L, "test3", "123", "email@example.com"), LocalDate.of(2022, 12, 10),
